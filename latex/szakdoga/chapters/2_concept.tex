...
\centering
\scriptsize
\setlength{\arrayrulewidth}{0.5pt} % vékonyabb vonalak
...
Task / Subtask & Igen, \makecell[l]{Epic $\rightarrow$ Story \\ Task $\rightarrow$ Subtask} & Igen, kártya / checklist & Igen, \makecell[l]{Epic $\rightarrow$ Story \\ Task $\rightarrow$ Subtask} \\
...
Integrációk & Igen, alap, kulcs szolgáltatások & Részben, Power-Ups & Igen, széles \newline (Confluence, GitHub, Slack...) \\
\hline
\end{tabularx}
