...
Az áttekintésben négy elterjedt, iparban széles körben használt projektmenedzsment rendszer kerül bemutatásra: a JIRA, a Trello, az Asana és a Redmine. Minden eszköz azonos szempontok szerint kerül elemzésre: bemutatásra kerülnek főbb funkciói, előnyei és hátrányai, majd kitérünk arra, hogy az adott rendszer milyen inspirációt jelentett az Acxor tervezése és fejlesztése során. Az áttekintést egy összehasonlító táblázat zárja, amely az Acxort a vizsgált eszközökkel helyezi közös kontextusba.
...
\begin{tabularx}{\textwidth}{|l|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}p{3.0cm}|}
\hline
...
Task / Subtask & Epic $\rightarrow$ Story, Task $\rightarrow$ Subtask & Kártya / checklist & Epic $\rightarrow$ Story, Task $\rightarrow$ Subtask \\
