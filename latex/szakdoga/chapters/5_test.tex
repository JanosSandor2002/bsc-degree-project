...
\begin{figure}[h!]
\centering
% IDE KERÜL: Képernyőkép -- a Vitest teszteredmény terminálban (zöld pipák)
\fbox{\parbox{14cm}{\centering\vspace{3.5cm} [Vitest terminál kimenet: az összes frontend teszteset eredménye (PASS / zöld pipák)] \vspace{3.5cm}}}
\caption{A frontend unit tesztek futtatásának eredménye (Vitest)}
\label{fig:vitest-output}
\end{figure}

\begin{figure}[h!]
\centering
% IDE KERÜL: Képernyőkép -- a Jest teszteredmény terminálban (zöld pipák)
\fbox{\parbox{14cm}{\centering\vspace{3.5cm} [Jest terminál kimenet: az összes backend integrációs teszteset eredménye (PASS / zöld pipák, összesítő statisztika)] \vspace{3.5cm}}}
\caption{A backend integrációs tesztek futtatásának eredménye (Jest)}
\label{fig:jest-output}
\end{figure}
