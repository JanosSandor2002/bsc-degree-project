...
#### Alkalmazás a szoftverfejlesztésben

- Státuszváltás (Task Done → XP)
- Sprint lezárás → Badge
- Visszajelzés → értesítések, bot üzenetek

### Felhőalapú rendszerek és valós idejű szinkronizáció
