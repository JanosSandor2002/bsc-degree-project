...
\begin{figure}[h!]
\centering
% IDE KERÜL: TasksView képernyőkép -- a feladatlista, a szerkesztési form és az XP toast látható
\fbox{\parbox{14cm}{\centering\vspace{4.5cm} [TasksView képernyőkép: feladatlista kártyákkal, inline szerkesztési form, XP toast értesítés] \vspace{4.5cm}}}
\caption{A TasksView komponens megjelenése}
\label{fig:tasks-view}
\end{figure}
...
\begin{figure}[h!]
\centering
% IDE KERÜL: KanbanView képernyőkép -- három oszlop: To Do, In Progress, Done
\fbox{\parbox{14cm}{\centering\vspace{4.5cm} [KanbanView képernyőkép: három oszlop (To Do, In Progress, Done) feladatkártyákkal] \vspace{4.5cm}}}
\caption{A KanbanView komponens megjelenése}
\label{fig:kanban-view}
\end{figure}
...
\begin{figure}[h!]
\centering
% IDE KERÜL: ScrumView képernyőkép -- sprint selector gombok, sprint info bar, Kanban oszlopok, Backlog szekció
\fbox{\parbox{14cm}{\centering\vspace{4.5cm} [ScrumView képernyőkép: sprint váltógombok, sprint statisztika, Kanban board, backlog szekció] \vspace{4.5cm}}}
\caption{A ScrumView komponens megjelenése}
\label{fig:scrum-view}
\end{figure}
...
\begin{figure}[h!]
\centering
% IDE KERÜL: GamificationView képernyőkép -- rangsor kártyák XP progress barral, badge-ekkel
\fbox{\parbox{14cm}{\centering\vspace{4.5cm} [GamificationView képernyőkép: rangsor kártyák, XP progress bar, badge szintek, accordion panel] \vspace{4.5cm}}}
\caption{A GamificationView komponens megjelenése}
\label{fig:gamification-view}
\end{figure}
...
\begin{figure}[h!]
\centering
% IDE KERÜL: Mobil alkalmazás képernyőképek -- Tasks, Subtasks és Kanban nézetek egymás mellett
\fbox{\parbox{14cm}{\centering\vspace{6cm} [Mobil alkalmazás képernyőképek: Tasks nézet, Subtasks összecsukható listával, Kanban oszlopok mobilon] \vspace{6cm}}}
...
\begin{figure}[h!]
\centering
% IDE KERÜL: Jest teszteredmények terminál képernyőkép
% (zöld pipákkal a sikeres tesztek: auth, projects, tasks, subtasks, services)
\fbox{\parbox{14cm}{\centering\vspace{3.5cm} [Jest teszteredmények: terminál kimenet zöld pipákkal, az összes tesztcsomag és teszteset listájával] \vspace{3.5cm}}}
...
\begin{figure}[h!]
\centering
% IDE KERÜL: Vitest teszteredmények terminál képernyőkép
% (zöld pipákkal a sikeres frontend tesztek listája)
\fbox{\parbox{14cm}{\centering\vspace{3.5cm} [Vitest teszteredmények: terminál kimenet a frontend unit tesztek eredményével (Reducer, Context, Actions, Components)] \vspace{3.5cm}}}
\caption{A frontend tesztek futtatásának eredménye}
\label{fig:vitest-results}
\end{figure}
